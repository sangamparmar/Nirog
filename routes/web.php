...
Route::middleware(['auth'])->group(function(){
    ...
    Route::get('dashboard/product-stats',[DashboardController::class,'productStats'])->name('product.stats');
    Route::get('dashboard/categories',[DashboardController::class,'categories'])->name('api.categories');
